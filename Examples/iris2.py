...
if __name__ == '__main__':
    ...
    e1 = EncoderGFR(
        ...
        in_min=0, in_max=1,
        threshold=0.8, gamma=1.5, delay_max=1,
        spike_all_last=True
    )
    b1 = Block(
        depth=1, size=n1,
        neuron_type=IF(threshold=2.8),
        learner=l1
    )
    c1 = Connection(e1, b1, mu=0.5, sigma=0.20, wmin=-0.3, wmax=1)
    ...
    b2 = Block(depth=1, size=n2, neuron_type=IF(threshold=1.9), learner=l2)
