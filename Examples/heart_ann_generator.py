...
"""
Continued from whetstone demo script.
Generates ANN with specificity to export the weights to an SNN, to classify the Heart Disease dataset with 3 layers.
"""
