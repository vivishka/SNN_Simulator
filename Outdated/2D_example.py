...
"""
Generates some images with determined patterns and train a layer of CNN to see if those patterns are detected by the
network.
...
e1 = EncoderGFR(depth=4, size=img_size, in_min=0, in_max=255, delay_max=1, threshold=0.9)
b1 = Block(4, img_size, LIF(threshold=1), learner=SimplifiedSTDP(eta_up=0.1, eta_down=0.1))
...
c_encoder = DiagonalConnection(e1, d1)
c2 = Connection(b1, d2, kernel=1)
