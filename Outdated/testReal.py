...
if __name__ == '__main__':
    ...
    b1 = Block(30, img_size, IFReal(threshold=2 ** 12 * 5), SimplifiedSTDP(
        eta_up=0.2,
        eta_down=-0.2,
        mp=True
    ))
    ...
    c1 = Connection(e1, b1, kernel_size=5, mode='shared', wmin=0, wmax=12, integer_weights=True)
    cps = []
    for con in c1:
    ...
    sim = Simulator(network=model, dataset=image_dataset,  dt=0.05, input_period=1, batch_size=1)
