...
if __name__ == '__main__':
    ...
    b1 = Block(15, img_size, IF(threshold=1.8), SimplifiedSTDP(
        eta_up=0.003,
        eta_down=-0.003,
        mp=True
    ))
    ...
    b1p = Block(15, (14, 14), IF(threshold=1))
    c1p = Connection(b1, b1p, kernel_size=2, mode='pooling')

    b2 = Block(45, size=(14, 14), neuron_type=IF(threshold=1.8), learner=SimplifiedSTDP(
        eta_up=0.003,
        eta_down=-0.003,
        mp=True
    ))
